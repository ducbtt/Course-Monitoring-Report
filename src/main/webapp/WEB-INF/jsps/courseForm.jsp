		...
		<div class="panel panel-success">
			...
			<div class="panel-body" style="min-height: 500px;">
				...
				<form:form id="courseFormId" cssClass="form-horizontal"
					modelAttribute="courseForm" method="post" action="saveCourse">
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<form:hidden id="actionId" path="action" value="${courseForm.action}" />
							<c:if test="${courseForm.action eq 'update'}">
								<form:input cssClass="form-control" path="crsCode"
									value="${courseForm.crsCode}" disabled="disabled"
									readonly="true" required="required" />
							</c:if>
							<c:if test="${courseForm.action eq 'create'}">
								<form:input cssClass="form-control" path="crsCode"
									value="${courseForm.crsCode}" maxlength="20"
									required="required" />
							</c:if>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<form:select cssClass="form-control" path="clId">
								<form:option value="">&nbsp;</form:option>
								<form:options items="${courseForm.cls}"
									itemLabel="usrFname"
									itemValue="usrId" />
							</form:select>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<form:select cssClass="form-control" path="cmId">
								<form:option value="">&nbsp;</form:option>
								<form:options items="${courseForm.cms}"
									itemLabel="usrFname"
									itemValue="usrId" />
							</form:select>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<c:forEach items="${facultyList}" var="faculty" varStatus="status">
								<form:checkbox path="facultyIds" value="${faculty.facultyId }"/>&nbsp;${faculty.name} <br>
							</c:forEach>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-xs-1" style="margin-right: 20px;">
								<input type="button" id="allCoursesId"
									...
									onclick="location.href='allCourses'" />
							</div>
							<div class="col-xs-1">
								<input type="submit" id="saveCourseId"
